  ...
  (let ((vertex-type '(:struct textured-2d-vertex))
    ...
    (with-slots (ptr fill-pointer allocated-count) textured-2d-vertex-array
      ...
      (let ((ptr (mem-aptr ptr vertex-type fill-pointer)))
        ...
        (setf (textured-2d-vertex-x ptr) (clampf x)
              (textured-2d-vertex-y ptr) (clampf y)
              (textured-2d-vertex-u ptr) (clampf u)
              (textured-2d-vertex-v ptr) (clampf v)
              (textured-2d-vertex-col ptr) color)
        (prog1 fill-pointer
          (incf fill-pointer))))))
    ...
    (with-slots (ptr fill-pointer allocated-count) vertex-array
      (unless (< fill-pointer allocated-count)
        (let* ((new-count (* 2 allocated-count))
          ...
          (foreign-free old-array)))
      (let ((ptr (mem-aptr ptr vertex-type fill-pointer)))
        (setf (textured-3d-vertex-x ptr) (clampf x)
              (textured-3d-vertex-y ptr) (clampf y)
              (textured-3d-vertex-z ptr) (clampf z)
              (textured-3d-vertex-u ptr) (clampf u)
              (textured-3d-vertex-v ptr) (clampf v)
              (textured-3d-vertex-col ptr) color)
        (prog1 fill-pointer
          (incf fill-pointer))))))
    ...
    (with-slots (ptr fill-pointer allocated-count) vertex-array
      ...
      (let ((ptr (mem-aptr ptr vertex-type fill-pointer)))
        (setf (textured-3d-vertex-x ptr) (clampf x)
              ...
              (textured-3d-vertex-v ptr) (clampf v)
              (textured-3d-vertex-col ptr) color
              (textured-3d-vertex-with-normal-nx ptr) (clampf nx)
              (textured-3d-vertex-with-normal-ny ptr) (clampf ny)
              (textured-3d-vertex-with-normal-nz ptr) (clampf nz))
        (incf fill-pointer)))))
