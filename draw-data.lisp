...
(defun %draw-data-add-2d-point-primitive (draw-data handle atom-group model-mtx sf-point-size ub32-color sf-x sf-y)
  ...
  (let* ((draw-list (draw-data-2d-point-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-2d-point draw-list atom-group model-mtx sf-point-size ub32-color sf-x sf-y))
    (values)))
...
(defun %draw-data-add-3d-point-primitive (draw-data handle atom-group model-mtx sf-point-size ub32-color sf-x sf-y sf-z)
  (declare (type retained-mode-draw-data draw-data))
  (declare (type single-float sf-point-size))
  (let* ((draw-list (draw-data-3d-point-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-3d-point draw-list atom-group model-mtx sf-point-size ub32-color sf-x sf-y sf-z))
    (values)))
...
(defun %draw-data-add-2d-line-primitive
    (draw-data handle atom-group model-mtx sf-line-thickness ub32-color sf-x0 sf-y0 sf-x1 sf-y1)
  (declare (type retained-mode-draw-data draw-data))
  (let* ((draw-list (draw-data-2d-line-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-2d-line draw-list atom-group model-mtx sf-line-thickness ub32-color sf-x0 sf-y0 sf-x1 sf-y1))
    (values)))
...
(defun %draw-data-add-3d-line-primitive
    (draw-data handle atom-group model-mtx sf-line-thickness ub32-color sf-x0 sf-y0 sf-z0 sf-x1 sf-y1 sf-z1)
  (declare (type retained-mode-draw-data draw-data))
  (let* ((draw-list (draw-data-3d-line-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-3d-line draw-list atom-group model-mtx sf-line-thickness ub32-color
...
(defun %draw-data-add-2d-triangle-primitive (draw-data handle atom-group model-mtx sf-line-thickness ub32-color
					     sf-x0 sf-y0 sf-x1 sf-y1 sf-x2 sf-y2)
  (declare (type retained-mode-draw-data draw-data))
  (let* ((draw-list (draw-data-2d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
	  (%draw-list-add-2d-polyline draw-list atom-group model-mtx t sf-line-thickness ub32-color
				      (list sf-x0 sf-y0 sf-x1 sf-y1 sf-x2 sf-y2)))
    
    (values)))

(defun %draw-data-add-multicolor-2d-polyline-primitive
    (draw-data handle atom-group model-mtx bool-closed? sf-line-thickness seq-vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-2d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-multicolor-2d-polyline
	   draw-list atom-group model-mtx bool-closed? sf-line-thickness seq-vertices))
    (values)))
...
(defun %draw-data-add-2d-polyline-primitive
    (draw-data handle atom-group model-mtx closed? sf-line-thickness ub32-color seq-vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-2d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-2d-polyline
           draw-list atom-group model-mtx closed? sf-line-thickness ub32-color seq-vertices))
    (values)))
...
(defun %draw-data-add-2d-circular-arc-primitive (draw-data handle atom-group model-mtx closed? line-thickness color
  ...
  (let ((draw-list (draw-data-2d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-2d-circular-arc
           draw-list atom-group model-mtx
...
(defun %draw-data-add-2d-circle-primitive (draw-data handle atom-group model-mtx line-thickness color
					   center-x center-y radius number-of-segments)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-2d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-2d-circle
           draw-list atom-group model-mtx line-thickness color
...
(defun %draw-data-add-multicolor-3d-polyline-primitive (draw-data handle atom-group model-mtx closed? line-thickness vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-multicolor-3d-polyline
           draw-list atom-group model-mtx closed? line-thickness vertices))
    (values)))
...
(defun %draw-data-add-3d-polyline-primitive (draw-data handle atom-group model-mtx closed? line-thickness color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-line-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-3d-polyline
           draw-list atom-group
...
(defun %draw-data-add-filled-2d-triangle-list-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let* ((draw-list (draw-data-2d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
	  (%draw-list-add-filled-2d-triangle-strip/list draw-list atom-group model-mtx color vertices))
    (values)))
...
(defun %draw-data-add-filled-2d-triangle-strip-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
...
(defun %draw-data-add-filled-2d-rectangle-list-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let* ((draw-list (draw-data-2d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
	  (%draw-list-add-filled-2d-rectangle-list draw-list atom-group model-mtx color vertices))
    (values)))
...
(defun %draw-data-add-textured-2d-rectangle-list-primitive (draw-data handle atom-group model-mtx texture color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-2d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-textured-2d-rectangle-list draw-list atom-group model-mtx texture color vertices))
    (values)))
...
(defun %draw-data-add-filled-2d-convex-polygon-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-2d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
...
(defun %draw-data-add-filled-3d-convex-polygon-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
...
(defun %draw-data-add-multicolor-3d-convex-polygon-primitive (draw-data handle atom-group model-mtx vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
...
(defun %draw-data-add-filled-3d-convex-polygon-with-normals-primitive
    (draw-data handle atom-group model-mtx ub32-color vertices light-position)
  (declare (type retained-mode-draw-data draw-data))
...
(defun %draw-data-add-multicolor-3d-convex-polygon-with-normals-primitive
    (draw-data handle atom-group model-mtx vertices light-position)
  (declare (type retained-mode-draw-data draw-data))
  (let* ((draw-list (draw-data-3d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-multicolor-3d-convex-polygon-with-normals
           draw-list atom-group model-mtx vertices light-position))
    (values)))
...
(defun %draw-data-add-filled-3d-triangle-list-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-filled-3d-triangle-strip/list draw-list atom-group model-mtx color vertices))
    (values)))
...
(defun %draw-data-add-filled-3d-triangle-strip-primitive (draw-data handle atom-group model-mtx color vertices)
  (declare (type retained-mode-draw-data draw-data))
...
(defun %draw-data-add-filled-3d-triangle-list-with-normals-primitive
    (draw-data handle atom-group model-mtx color vertices light-position)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-triangle-list-with-normals-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-filled-3d-triangle-strip/list-with-normals
           draw-list
           atom-group model-mtx color vertices light-position))
    (values)))
...
(defun %draw-data-add-textured-3d-triangle-list-primitive (draw-data handle atom-group model-mtx texture color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-triangle-list-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
...
(defun %draw-data-add-textured-3d-triangle-strip-primitive (draw-data handle atom-group model-mtx texture color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-triangle-strip-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-textured-3d-triangle-strip/list
...
(defun %draw-data-add-filled-sphere-primitive
    (draw-data handle atom-group model-mtx color origin-x origin-y origin-z radius resolution light-position)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-3d-triangle-list-with-normals-draw-list draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-filled-sphere
	   draw-list atom-group model-mtx color origin-x origin-y origin-z radius resolution light-position))
    (values)))
...
(defun %draw-data-add-text-quad-list-primitive (draw-data handle atom-group model-mtx font color vertices)
  (declare (type retained-mode-draw-data draw-data))
  (let ((draw-list (draw-data-2d-triangle-list-draw-list-for-text draw-data)))
    (setf (gethash handle (draw-data-handle-hash-table draw-data))
          (%draw-list-add-textured-2d-rectangle-list
           draw-list atom-group model-mtx (font-atlas font) color vertices
           #'(lambda (&rest args)
