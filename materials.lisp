...
(defclass material-mixin ()
  ((name :initform "default" :initarg :name :accessor material-name :type (or string symbol))
   (ambient :initform #(0.7 0.7 0.7 1.0) :initarg :ambient :accessor material-ambient :type color)
   (diffuse :initform #(0.7 0.7 0.7 1.0) :initarg :diffuse :accessor material-diffuse :type color)
