...
(defclass material-mixin ()
  ((name :initform "default" :initarg :name :accessor material-name :type (or string symbol))
   (ambient :initform #(0.5 0.5 0.5 1.0) :initarg :ambient :accessor material-ambient :type color)
   (diffuse :initform #(0.5 0.5 0.5 1.0) :initarg :diffuse :accessor material-diffuse :type color)
   (specular :initform #(0.5 0.5 0.5 1.0) :initarg :specular :accessor material-specular :type color)
   (shininess :initform 9.0f0 :initarg :shininess :accessor material-shininess :type real))
